...
class InputData(object):
    ...
    def get_test_NDS(self, min_blobs=1, max_blobs=1):
        """Generate and get test NDS images and labels."""
        self.images, self.labels = create_NDS_data.generate_data(min_blobs, max_blobs)
        self.length = len(self.images)
